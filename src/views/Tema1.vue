  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      .col-md-8.col-12
        ...
        p Básicamente se puede concluir que el plan de mercadeo es el punto de partida del plan de producción y a partir de allí se inicia un proceso de comunicación de doble vía entre el área de mercadeo y producción, el área de mercadeo a partir del estudio e investigación de mercado realizada de manera preoperativa es quien pasa la información al área de producción de cuál es la cantidad de productos o servicios que debe realizar para satisfacer la demanda de los clientes proyectados de la organización, a su vez el área de producción identifica su capacidad instalada y define la cantidad real con la que puede responder a la demanda de mercado y a partir de allí se puede realizar ajustes o rediseñar estrategias establecidas por el área de mercadeo.
